...
const reviews = [
  {
    ...
    rating: 5,
    text: 'সেরা ফ্যাশন হাউসের ড্রেসগুলো সত্যি অনন্য। কাপড়ের মান এবং ডিজাইন আমাকে মুগ্ধ করেছে। তাদের ডেলিভারি সার্ভিসও খুব দ্রুত।',
  ...
  },
  {
    ...
    location: 'বনানী, ঢাকা',
    rating: 5,
    text: 'প্রিমিয়াম কোয়ালিটির জন্য সেরা ফ্যাশন হাউস এখন আমার প্রথম পছন্দ। গত মাসে দুটি থ্রিপিস অর্ডার করেছিলাম, একদম ছবির মতোই পেয়েছি।',
  ...
  },
  {
    ...
    location: 'চট্টগ্রাম',
    rating: 5,
    text: 'খুবই সুন্দর ডিজাইন। সচরাচর এমন ইউনিক কালেকশন অন্য কোথাও দেখা যায় না। ধন্যবাদ সেরা ফ্যাশন হাউসকে।',
